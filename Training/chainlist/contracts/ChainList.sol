...
//sell one article by specifying the seller, the article’s name, description and price
//retrieve the article’s seller’s address, its name, description and price
